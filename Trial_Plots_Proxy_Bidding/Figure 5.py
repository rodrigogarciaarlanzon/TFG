...
x10, y10, z10 = comparacion_simulaciones(10, 0.2, 1000)
x20, y20, z20 = comparacion_simulaciones(20, 0.2, 1000)
x40, y40, z40 = comparacion_simulaciones(40, 0.2,  1000)
...
# Título y ejes
ax.set_title("Auction revenue on the number of bidders N", fontsize=18)
ax.set_xlabel("Minimum did increment d", fontsize=16)
